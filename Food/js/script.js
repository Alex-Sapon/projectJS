document.addEventListener('DOMContentLoaded', function() {
    ...
    function setStaticInformation(parentSelector, classActive) {
    ...
    setStaticInformation('#gender', 'calculating__choose-item_active');
    setStaticInformation('.calculating__choose_big', 'calculating__choose-item_active');
});
